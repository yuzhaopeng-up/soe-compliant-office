...
Use `tabler-filled` as the stylistic icon library for this template. Its rounded filled forms keep the professional, warm psychology tone while remaining more legible than thin line icons in projection and print.

### Placeholder Format

```xml
<use data-icon="tabler-filled/icon-name" x="X" y="Y" width="32" height="32" fill="COLOR"/>
```
...
| Concept              | Icons                     |
| -------------------- | ------------------------- |
| Attachment/Bonding   | `tabler-filled/heart`, `tabler-filled/link` |
| Secure Base          | `tabler-filled/home`, `tabler-filled/shield-check` |
| Mentalization        | `tabler-filled/bulb`, `tabler-filled/message-circle` |
| Affect Regulation    | `tabler-filled/adjustments-horizontal`, `tabler-filled/chart-dots` |
| Awareness            | `tabler-filled/eye`, `tabler-filled/compass` |
| Trauma               | `tabler-filled/alert-triangle`, `tabler-filled/bolt` |
| Repair               | `tabler-filled/circle-arrow-right`, `tabler-filled/settings` |
| Development          | `tabler-filled/chart-area-line`, `tabler-filled/stack-2` |
